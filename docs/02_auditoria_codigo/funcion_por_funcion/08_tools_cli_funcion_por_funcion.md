...
| `_append_capture_row` | sesion/captura | Markdown row | AÃ±ade fila a plantilla sesion | Bajo |
...
| `cmd_finish` | cierre sesion | Markdown | AÃ±ade hora fin/decision/comentario | Bajo |
...
- fija escala EEG estandar en Â±400 uV para no aplastar la seÃ±al util con transitorios;
