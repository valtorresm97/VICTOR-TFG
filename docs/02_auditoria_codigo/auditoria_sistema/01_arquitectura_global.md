...
Este documento describe la arquitectura global del sistema EEG-MIDI en lenguaje narrativo y transversal. A diferencia de `docs/02_auditoria_codigo/funcion_por_funcion/`, que enumera funciones y contratos de forma tabular, este archivo busca explicar el funcionamiento completo del sistema de forma util para:
...
MCU Arduino UNO Q / STM32U585
   â†“ filtrado MCU + bloques de 8 muestras
...
MidiScheduler
   â†“
MidiByteTransport
   â†“ Bridge.call("midi_bytes", n, b0, b1, b2)
