...
3. No duplicar en exceso lo ya consolidado en `02_auditoria_codigo/funcion_por_funcion/`.
...
La carpeta `02_auditoria_codigo/funcion_por_funcion/` ya contiene la revision final-v4 funcion por funcion. Esta carpeta se revisara despues como auditoria transversal para:
...
1. Revisar `00_inventario_proyecto.md` y decidir si se actualiza o se marca como sustituido por `02_auditoria_codigo/funcion_por_funcion/00_inventario_actual.md`.
