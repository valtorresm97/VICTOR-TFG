...
La metadata adicional de sujeto/sesion debe escribirse en `--notes` y en la plantilla `docs/templates/plantilla_sesion_sujeto.md`.
...
- No hay saturacion ni señal plana.
...
docs/sesiones_captura/<session>_<subject>_sesion.md
