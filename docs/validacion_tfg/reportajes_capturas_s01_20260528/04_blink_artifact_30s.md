...
Esta captura se dise̱o como una condicion de artefacto fisiologico controlado. El sujeto realiza parpadeos marcados durante la captura.
...
La adquisicion fue estable, pero el estado no debe considerarse fisiologicamente limpio por dise̱o experimental.
...
La grafica temporal es clave para este tipo de condicion, porque permite observar si los parpadeos generan transitorios visibles en la se̱al. La finalidad no es minimizar el artefacto, sino documentarlo.
...
![Calidad de se̱al y gate](../figures/capturas_finales_s01_20260528_matplotlib/20260528-145635_s01_20260528_ear_eeg_ch1_only_04_blink_artifact_30s/calidad_senal_quality_gate.png)

Esta figura es especialmente importante en la captura de parpadeo, porque permite distinguir la respuesta musical de la calidad de las ventanas contaminadas. La captura se interpreta como artefacto fisiologico controlado, no como EEG limpio.
...
Se registraron 34 notas deduplicadas. La salida musical existe, pero no debe interpretarse como reflejo directo de estado EEG limpio. Es la respuesta del sistema ante una se̱al con contaminacion fisiologica controlada.
