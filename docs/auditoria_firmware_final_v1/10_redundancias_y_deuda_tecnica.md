...
| `compute_quality_diagnostics()` puede duplicar trabajo espectral | `eeg_signal_processor.py` | Coste extra, aunque benchmarks muestran margen. | Media | No optimizar prematuramente; solo reusar PSD si se rediseña con tests. |
