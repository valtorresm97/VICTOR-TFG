...
No todos los controles faltantes deben implementarse. Algunos se dejan fuera de forma deliberada porque aumentarian complejidad, romperian comparabilidad de capturas o expondrían configuracion peligrosa al usuario.
