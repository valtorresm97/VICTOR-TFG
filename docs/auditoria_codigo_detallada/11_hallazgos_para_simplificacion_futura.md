...
| `compute_quality_diagnostics()` recalcula PSD para diagnostico | `eeg_signal_processor.py` | Coste CPU | Puede duplicar trabajo con features live | Reusar contexto si se rediseña | Media |
...
### Fase D - Refactor suave con commits pequeños
